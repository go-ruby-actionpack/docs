...
The public API lives at the module root (`github.com/go-ruby-actionpack/actionpack`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `actionpack`, while the surface follows
...
```go
import "github.com/go-ruby-actionpack/actionpack"
```
...
- **[pkg.go.dev/github.com/go-ruby-actionpack/actionpack](https://pkg.go.dev/github.com/go-ruby-actionpack/actionpack)**

The module's [README](https://github.com/go-ruby-actionpack/actionpack#readme) carries worked
