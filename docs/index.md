# go-ruby-actionpack documentation

**Pure-Go, MRI-4.0.5-faithful Ruby actionpack (no cgo)**

`go-ruby-actionpack/actionpack` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `actionpack`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-actionpack/actionpack`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `actionpack`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-actionpack/actionpack
```
...
| Repo | What it is |
| --- | --- |
| [`actionpack`](https://github.com/go-ruby-actionpack/actionpack) | the library — Ruby's `actionpack` in pure Go |
| [`docs`](https://github.com/go-ruby-actionpack/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-actionpack.github.io`](https://github.com/go-ruby-actionpack/go-ruby-actionpack.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-actionpack/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-actionpack/actionpack](https://github.com/go-ruby-actionpack/actionpack).
